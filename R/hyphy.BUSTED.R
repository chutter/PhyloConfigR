#' @title hyphy.BUSTED
#'
#' @description Runs HyPhy BUSTED (Branch-site Unrestricted Statistical Test for
#'   Episodic Diversification) across a directory of matched gene tree and alignment
#'   pairs. Trees and alignments are pruned to the same taxon set before running.
#'   Results are written as JSON files in a subdirectory under "hyphy/". Use
#'   hyphy.Parser(hyphy.analysis = "BUSTED") to summarize outputs.
#'
...
#'
#' @param dataset.name name for the output subdirectory under "hyphy/" (default: "busted")
#'
...
#'
#' @return JSON result files are written to "hyphy/\{dataset.name\}/\{locus\}/BUSTED-results.json";
#'   nothing is returned in R
#'
#' @examples
#'
#' hyphy.BUSTED(tree.directory = "gene-trees",
